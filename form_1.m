function [ output_args ] = form_1( gF )
%execute FORM given the global safety factor included in SFI, output=sum of weighted penalty function
%   used for:
%       calibrating gF
%   inputs: 
%       gF used in SFI
                ...
                for aG=input.aG(imat,1):input.step:input.aG(imat,2)
                    ...
                    switch input.des_eq
                        case 'EC0-6.10'
                         ...
                         case 'SFII'
                            kmod=[0.8 %kmod of the load with shortest duration 
                                  0.8
                                  0.8
                                  0.8
                                  0.8];
